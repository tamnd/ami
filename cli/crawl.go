...
func newCrawlCmd() *cobra.Command {
	...
	f.IntVar(&cfg.Workers, "workers", cfg.Workers, "number of concurrent fetch workers")
	...
	f.IntVar(&cfg.DomainFailThreshold, "domain-fail-threshold", cfg.DomainFailThreshold, "consecutive failures before a domain is skipped")
